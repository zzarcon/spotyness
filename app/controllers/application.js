...
export default Ember.Controller.extend({
  ...
  currentVideo: null,
  videoPlayer: null,
  playlists: Ember.inject.controller(),
  playlist: Ember.inject.controller(),
  activePlaylist: Ember.computed.alias('playlist'),
  myPlaylists: Ember.computed.alias('playlists.mine'),
  notMyPlaylists: Ember.computed.alias('playlists.mine'),
